...
CONFIG_DIR = os.path.expanduser("~/.config/biglinux-games-settings")
...
class BiglinuxSettingsApp(Adw.Application):
    def __init__(self):
        super().__init__(application_id="org.biglinux.biglinux-games-settings")
        GLib.set_prgname("biglinux-games-settings")
...
class BiglinuxSettingsWindow(Adw.ApplicationWindow):
    def __init__(self, **kwargs):
        ...
        self.set_title(_("BigLinux Games Settings"))
    ...
    def setup_ui(self):
        ...
        sidebar_header.set_title_widget(Adw.WindowTitle.new(_("BigLinux Games Settings"), ""))
